...
//                                                }
                ...
                for(i=1;i<=5;i++)//nonvegdinner
                {
                    ...
                    {
                    qry.prepare("SELECT foodname,amount,calories,carbohydrate,protein,fat FROM nonvegdinner WHERE number=13");
